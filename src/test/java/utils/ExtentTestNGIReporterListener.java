...
//        }
    ...
    private void init() {
        ...
        htmlReporter.config().setResourceCDN(ResourceCDN.EXTENTREPORTS);//加入这段代码，才能加载css
...
//            }
            ...
            for (ITestResult result : treeSet) {
                ...
                if(name.length()>0){
                    if(name.length()>50){
                        name= result.getTestClass().getName()+"."+result.getMethod().getMethodName() +"["+ name.substring(0,30)+"..."+"}]";
